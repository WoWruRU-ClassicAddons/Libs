...
BabbleZone:RegisterTranslations("enUS", function() return {
	["Ahn'Qiraj"] = true,
...
BabbleZone:RegisterTranslations("ruRU", function() return {
	["Ahn'Qiraj"] = "Ан'Кираж",
...
BabbleZone:RegisterTranslations("deDE", function() return {
	["Ahn'Qiraj"] = "Ahn'Qiraj",
...
BabbleZone:RegisterTranslations("frFR", function() return {
	["Ahn'Qiraj"] = "Ahn'Qiraj",
...
BabbleZone:RegisterTranslations("zhCN", function() return {
	["Ahn'Qiraj"] = "安其拉",
...
BabbleZone:RegisterTranslations("zhTW", function() return {
	["Ahn'Qiraj"] = "安其拉",
...
BabbleZone:RegisterTranslations("koKR", function() return {
	["Ahn'Qiraj"] = "안퀴라즈",
...
BabbleZone:RegisterTranslations("esES", function() return {
	["Ahn'Qiraj"] = "Ahn'Qiraj",

...
BabbleSpellTree:RegisterTranslations("enUS", function() return {
	-- Druid
	["Balance"] = true,
	["Feral Combat"] = true,
	["Restoration"] = true,
...
BabbleSpellTree:RegisterTranslations("ruRU", function() return {
	-- Druid
	["Balance"] = "Баланс",
...
BabbleSpellTree:RegisterTranslations("deDE", function() return {
	-- Druid
...
BabbleSpellTree:RegisterTranslations("frFR", function() return {
	-- Druid
	["Balance"] = "Equilibre",
...
BabbleSpellTree:RegisterTranslations("koKR", function() return {		
	-- Druid
	["Balance"] = "조화",
	["Feral Combat"] = "야성",
	["Restoration"] = "회복",
...
BabbleSpellTree:RegisterTranslations("zhCN", function() return {
	-- Druid
	["Balance"] = "平衡",
	["Feral Combat"] = "野性战斗",
	["Restoration"] = "恢复",
...
BabbleSpellTree:RegisterTranslations("zhTW", function() return {
	-- Druid
	["Balance"] = "平衡",
	["Feral Combat"] = "野性戰鬥",
	["Restoration"] = "恢復",
...
BabbleSpellTree:RegisterTranslations("esES", function() return {
	-- All classes
	["Hybrid"] = "Híbrido",
